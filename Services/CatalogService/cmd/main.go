...
func main() {
	...
	mux.Handle("/author/", middleware.VerifyAuthMiddleware(catalogHandler.GetAuthorInfo()))
	mux.Handle("/authors/", middleware.VerifyAuthMiddleware(catalogHandler.GetSongAuthors()))
	mux.Handle("/songs-by-author/", middleware.VerifyAuthMiddleware(catalogHandler.GetAllSongsByAuthor()))
